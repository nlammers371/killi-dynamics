...
if __name__ == "__main__":
    ...
    seg_model = "li_segmentation"
    suffix = ""
    config_name = "tracking_v0"
    start_i = 0  # start frame for tracking
    stop_i = None  # end frame for tracking

    perform_tracking(root, project_name, tracking_config=config_name, seg_model=seg_model, well_num=None,
                     start_i=start_i, stop_i=stop_i,  suffix=suffix, par_seg_flag=True, overwrite_tracking=True)