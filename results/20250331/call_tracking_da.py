...
if __name__ == "__main__":
    ...
    config_name = "tracking_20250328_da"
    start_i = 2100  # 2000 # start frame for tracking
    stop_i = None  # 2100  # end frame for tracking

    perform_tracking(root, project_name, tracking_config=config_name, seg_model=model_name, well_num=None,
                     start_i=start_i, stop_i=stop_i, use_fused=True, suffix="", par_seg_flag=True)