...
def write_napari_frames(i, viewer, image_full, mask_full, layer1, layer0, initial_angle, output_dir, zoom,
                        scale_vec, angle_increment, X, Y, Z, save_flag=True,
...
if __name__ == "__main__":
    ...
    # make output path
    output_dir = os.path.join(root, "figures", project, "screenshots_cb2", "")
    os.makedirs(output_dir, exist_ok=True)

    angle_increment = 0.61
    frame_increment = 1
    ...
    layer1 = viewer.add_image(image_full[0, 0], name='lcp', rendering='mip', colormap='green', scale=scale_vec,
                              contrast_limits=[135, 325], opacity=0.6)
