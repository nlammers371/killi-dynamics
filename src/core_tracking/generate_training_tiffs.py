...
def make_training_slices(project_path, n_samples=2, window_size=512):
    ...
    for im, image_path in enumerate(tqdm(image_list)):
        ...
        for image_i in range(len(slice_id_vec)):
            ...
            out_name = os.path.join(write_path, "_t0001_" + f'{rand_prefix:06}' + suffix + f'{slice_num:03}' + '_' + save_name)
...
if __name__ == "__main__":
    ...
    make_training_slices(project_path, n_samples=50)
